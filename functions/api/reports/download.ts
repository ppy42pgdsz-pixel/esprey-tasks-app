/**
 * GET /api/reports/download?file=<name>&company=<id>
 * Same outstanding-report PDF as /view, but returned as an ATTACHMENT so the
 * in-app Save link downloads the file. Only the Content-Disposition differs.
 */
